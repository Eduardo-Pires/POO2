...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
         * Diferença de tempo em milissegundos: 44 (10 arquivos)
         * Diferença de tempo em milissegundos: 56 (100 arquivos)
         * Diferença de tempo em milissegundos: 175 (1000 arquivos)
         */
